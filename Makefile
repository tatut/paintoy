...
web: paintoy.c input.h input_fetch.c
	emcc -o paintoy.html paintoy.c input_fetch.c -Os -Wall ./raylib-5.5_webassembly/lib/libraylib.a -I. -Iraylib-5.5_webassembly/include -L. -Lraylib-5.5_webassembly/lib/libraylib.a -s USE_GLFW=3 -s FETCH -DPLATFORM_WEB --shell-file shell.html
